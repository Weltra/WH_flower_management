                  ...
                  <el-tab-pane label="头像设置" name="change_avatar">
                    <div class="avatar-change">
                      <div class="avatar-change-section">
                        <div class="avatar-change-section-header"><span><i class="el-icon-picture-outline"></i>Change Avatar</span></div>
                        ...
                        <div class="avatar-change-section">
                          <div class="avatar-change-section-header"><span><i class="el-icon-copy-document"></i>Clipboard</span></div>
                          <div class="avatar-change-section-body">
                            <div class="text-muted">
